...
public:
    ...
    template <typename DocStatPredicat>
    vector<Document> FindTopDocuments(const string& raw_query, DocStatPredicat stat) const {
        const Query query = ParseQuery(raw_query);
        auto matched_documents = FindAllDocuments(query, stat);
...
private:
    ...
    template <typename DocStatPredicat>
    vector<Document> FindAllDocuments(const Query& query, DocStatPredicat stat) const {
